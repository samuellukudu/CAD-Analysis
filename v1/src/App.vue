    ...
    <q-header>
        <q-toolbar>
            ...
            <q-file color="white" label-color="white" filled bottom-slots clearable dense
                    v-model="inputFile" label="Select file or drag here" style="max-width: 300px;"
                    accept=".dxf"
                    class="q-ml-xl" dark @update:model-value="_OnFileSelected" @clear="_OnFileCleared">
            ...
            <div v-if="inputFile === null"
                ...
                <div class="col-auto" style="width: 300px;">
                    <q-file filled bottom-slots clearable
                            v-model="inputFile" label="Select file or drag here"
                            accept=".dxf"
                            class="col" @update:model-value="_OnFileSelected" @clear="_OnFileCleared">
                        <template v-slot:before>
...
export default {
    ...
    methods: {
        _OnFileSelected(file) {
            ...
            this.inputFile = file;
            // Handle FileList or single File object
            const fileToUse = file instanceof FileList ? file[0] : file;
            this.dxfUrl = URL.createObjectURL(fileToUse);
        },
